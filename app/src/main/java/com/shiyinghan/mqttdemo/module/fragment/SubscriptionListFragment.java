...
import com.shiyinghan.mqttdemo.adapter.SubscriptionListRecyclerViewAdapter;
import com.shiyinghan.mqttdemo.base.AbstractMvpFragment;
import com.shiyinghan.mqttdemo.databinding.DialogSubscriptionAddBinding;
import com.shiyinghan.mqttdemo.databinding.FragmentSubscriptionListBinding;
import com.shiyinghan.mqttdemo.module.contract.SubscriptionListContract;
import com.shiyinghan.mqttdemo.module.presenter.SubscriptionListPresenter;
...
public class SubscriptionListFragment extends AbstractMvpFragment<SubscriptionListPresenter>
    ...
    public void saveSubscriptionSuccess(SubscriptionEntity entity) {
        ...
        try {
            ...
            mClient.subscribe(entity.getTopic() + "2", entity.getQos(), this, new IMqttActionListener() {
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {
                    ToastUtil.show(getString(R.string.toast_subscribe_success, entity.getTopic()));
                }
