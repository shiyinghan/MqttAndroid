...
import com.shiyinghan.mqtt.android.service.MqttService;
...
public class AndroidServiceWithActionListenerTest extends ServiceTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        intent.setClassName("com.shiyinghan.mqtt.android.service", "MqttService");
    ...
    private static class ActionListener implements IMqttActionListener {
        private static final String TAG = ActionListener.class.getSimpleName();
